...
# pathname of frames
pathname = os.environ['HOME'] + '/GoogleDrive/Ondometro_Optico/data/videos/CAMERA 1/T100/'
...
time_ocr_str = [] # tempo retirado da imagem em string
...
while(cap.isOpened()):
    ...
    if ret:
        ...
        cv2.imwrite('../out/OCR/frames_CAM_01/%s_%s_frame_%s.png' %(filename[:-4], time_ocr_str[-1], f), im1)
