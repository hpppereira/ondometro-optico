...
Numeracao da crista:
primeira crista eh a mais proxima da camera

# teste 18/06/2018
camera inferior
video: T100_570003_CAM3.avi
tempo video: 0:00:51.995
pix_cr1_inf = 499
pix_cr2_inf = 421

camera superior
video: T100_570003_CAM3.avi
tempo video: 0:00:14.998
pix_cr1_sup = 911
pix_cr2_sup = 755
...
def calcular_angulos(f, pos_centro_ccd_px, pos_bal_1_px, alt_cam, alt_bal_nm, pix_cr):
    """
...
def calcular_altura_onda(alt_cam_inf=0.24, alt_cam_sup=0.48, dist_hor_proj_cr_inf=11.30, dist_hor_proj_cr_sup=9.36):
    """
...
if __name__ == '__main__':
    ...
    # loop para calculas as distancias de cada crista em cada camera
